...
export default function PricingPage() {
    return (
        <div className="min-h-screen bg-black text-white pt-32 pb-24 px-6 md:px-12 font-geist-sans selection:bg-green-500 selection:text-white">
            {/* Background */}
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                <div className="text-center mb-24">
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6">
                        INVEST IN YOUR <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600">SOUND</span>
                    </h1>
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
                    {/* Free Tier */}
                    <div className="p-8 rounded-3xl border border-white/10 bg-neutral-900/50 backdrop-blur-md">
                    ...
                    {/* Pro Tier */}
                    <div className="p-10 rounded-3xl border border-white/20 bg-gradient-to-b from-neutral-800 to-black relative shadow-2xl scale-105 z-10">
                    ...
                    {/* Studio Tier */}
                    <div className="p-8 rounded-3xl border border-white/10 bg-neutral-900/50 backdrop-blur-md">
                        <h3 className="text-2xl font-bold mb-2 text-blue-400">Studio</h3>
                        <div className="text-4xl font-black mb-6 flex items-baseline gap-1">

        ...
        <div className="min-h-screen bg-black text-white pt-32 pb-24 px-6 md:px-12 font-geist-sans selection:bg-ekko-500 selection:text-white">
            ...
            <div className="relative z-10 max-w-5xl mx-auto">
                <h1 className="text-5xl md:text-8xl font-black tracking-tighter mb-12">
                    BRAND <span className="text-transparent bg-clip-text bg-gradient-to-r from-ekko-400 to-ekko-600">ASSETS</span>
                </h1>

                <div className="grid md:grid-cols-2 gap-12 mb-20">
                    <div>
                        <h3 className="text-2xl font-bold mb-6">Logo</h3>
                        <div className="p-12 bg-neutral-900 rounded-none border border-white/10 flex items-center justify-center mb-6">
                    ...
                    <div>
                        ...
                        <div className="p-12 bg-white text-black rounded-none border border-white/10 flex flex-col justify-center mb-6 h-[200px]">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="h-32 rounded-none bg-black border border-white/10 p-4 flex items-end font-mono text-xs">#000000</div>
                        <div className="h-32 rounded-none bg-white text-black p-4 flex items-end font-mono text-xs">#FFFFFF</div>
                        <div className="h-32 rounded-none bg-ekko-500 p-4 flex items-end font-mono text-xs">#6366F1</div>
                        <div className="h-32 rounded-none bg-ekko-300 p-4 flex items-end font-mono text-xs">#A5B4FC</div>
                    </div>
                </div>
            </div>
        </div>

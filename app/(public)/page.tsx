...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-[100dvh] flex flex-col font-geist-sans bg-black text-white overflow-x-hidden selection:bg-ekko-500/30 selection:text-white">
            ...
            <AuroraBackground className="h-[100dvh] !fixed inset-0 z-0">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 md:px-8 h-full pt-48 md:pt-48">
                    <div className="z-10 flex items-center justify-center mb-8">
                        <Link href="/platform" className={cn("group rounded-none border border-black/5 bg-neutral-100/10 text-base transition-all ease-in hover:cursor-pointer hover:bg-neutral-200/10 dark:border-white/5 dark:bg-neutral-900/10 dark:hover:bg-neutral-900/20")}>
                    ...
                    >
                        <Link href="/login">
                            <Button className="h-12 px-8 text-sm font-semibold tracking-wide uppercase bg-white text-black hover:bg-neutral-200 rounded-none transition-all">
                                Start Creating
                            </Button>
                        </Link>
                        <Link href="/about">
                            <Button variant="outline" className="h-12 px-8 text-sm font-semibold tracking-wide uppercase rounded-none border-white/20 text-white hover:bg-white/5 transition-all">
                                Our Story
                            </Button>
                        </Link>
                    </motion.div>
            ...
            <div className="relative z-10 bg-black border-t border-white/10 shadow-2xl">
                    ...
                    <VelocityScroll defaultVelocity={2} className="font-bold uppercase tracking-widest text-sm md:text-base text-neutral-400">
                        <div className="flex items-center gap-12 mr-12">
                            <span className="flex items-center gap-4 text-white">
                                CREATE YOUR SOUND <Disc className="w-5 h-5 animate-spin-slow text-ekko-400" />
                            </span>
                            <span className="flex items-center gap-4 text-white">
                                SHARE THE VIBE <Users className="w-5 h-5 text-ekko-300" />
                            </span>
                            <span className="flex items-center gap-4 text-white">
                                AI POWERED CURATION <Sparkles className="w-5 h-5 text-ekko-400" />
                            </span>
                        </div>
                    </VelocityScroll>
                </div>
                ...
                <section className="py-24 px-6 md:px-12 lg:px-24 border-b border-white/10 bg-black relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto mb-16 text-center relative z-10">
                        <div className="inline-block relative">
                            <div className="absolute -inset-4 bg-ekko-500/10 blur-xl rounded-full" />
                            <h2 className="relative text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-4 text-transparent bg-clip-text bg-gradient-to-r from-ekko-400 via-ekko-100 to-white drop-shadow-[0_2px_10px_rgba(99,102,241,0.45)] transform hover:scale-105 transition-transform duration-500 cursor-default">
                                OUR RHYTHM
                            </h2>
                        </div>
                        <p className="text-neutral-300 max-w-2xl mx-auto text-lg font-medium drop-shadow-md">
                            ...
                            <span className="italic text-ekko-200/80">&quot;Dito ang simula.&quot; (It starts here.)</span>
                        </p>
                    </div>
                    ...
                    <BentoGrid className="max-w-6xl mx-auto relative z-10">
                        <BentoCard
                            ...
                            header={<div className="flex-1 w-full h-full min-h-[6rem] rounded-none bg-gradient-to-br from-ekko-900/20 to-neutral-900 border border-white/5 relative overflow-hidden group">
                                <Image
                                ...
                                />
                                <div className="absolute inset-0 flex items-center justify-center opacity-40 mix-blend-overlay overflow-hidden">
                            ...
                            icon={<Mic2 className="h-4 w-4 text-ekko-400" />}
                            className="md:col-span-2 border-white/5 bg-neutral-900/80 backdrop-blur-sm hover:border-ekko-500/30 transition-all group shadow-glow-primary"
                            href="/platform"
                        />
                        <BentoCard
                            ...
                            header={<div className="flex-1 w-full h-full min-h-[6rem] rounded-none bg-gradient-to-br from-ekko-900/20 to-neutral-900 border border-white/5 flex items-center justify-center group relative overflow-hidden">
                                <Image
                                ...
                                />
                                <div className="absolute inset-0 bg-ekko-500/10 mix-blend-overlay" />
                                <div className="absolute inset-0 z-0 opacity-30">
                                    <Marquee vertical className="[--duration:20s]">
                                        {["🇵🇭", "🎶", "🔥", "✨", "🎸", "🥁"].map((item, idx) => (
                                            <span key={idx} className="text-2xl mx-auto">{item}</span>
                                        ))}
                                    </Marquee>
                                </div>
                                <Users className="w-12 h-12 text-ekko-400/80 group-hover:text-ekko-300 transition-colors group-hover:scale-110 duration-300 relative z-10 drop-shadow-xl" />
                                <BorderBeam size={250} duration={12} delay={9} />
                            </div>}
                            icon={<Users className="h-4 w-4 text-ekko-400" />}
                            className="md:col-span-1 border-white/5 bg-neutral-900/80 backdrop-blur-sm hover:border-ekko-500/30 transition-all group"
                            href="/discover"
                        />
                        <BentoCard
                            ...
                            header={<div className="flex-1 w-full h-full min-h-[6rem] rounded-none bg-gradient-to-br from-ekko-900/20 to-neutral-900 border border-white/5 flex items-center justify-center group overflow-hidden relative">
                                <Image
                                ...
                                <div className="absolute inset-0 flex items-center justify-center z-10">
                                    <div className="w-32 h-32 border border-ekko-500/20 rounded-full animate-ping opacity-20" />
                                </div>
                                <div className="flex -space-x-4 relative z-10">
                                    <div className="w-8 h-8 rounded-full bg-ekko-500/20 border border-ekko-500/50 backdrop-blur-md" />
                                    <div className="w-8 h-8 rounded-full bg-ekko-400/20 border border-ekko-400/50 backdrop-blur-md" />
                                    <div className="w-8 h-8 rounded-full bg-ekko-300/20 border border-ekko-300/50 backdrop-blur-md" />
                                </div>
                                <BorderBeam size={250} duration={12} delay={9} />
                            </div>}
                            icon={<Globe className="h-4 w-4 text-ekko-400" />}
                            className="md:col-span-1 border-white/5 bg-neutral-900/80 backdrop-blur-sm hover:border-ekko-500/30 transition-all group"
                            href="/platform"
                        />
                        <BentoCard
                            ...
                            header={<div className="flex-1 w-full h-full min-h-[6rem] rounded-none bg-gradient-to-br from-ekko-900/20 to-neutral-900 border border-white/5 relative overflow-hidden group">
                                <Image
                                    ...
                                    className="object-cover opacity-50 group-hover:opacity-70 transition-opacity duration-500 transform group-hover:scale-105"
                                />
                                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-ekko-500/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 z-10" />
                                <div className="absolute inset-0 flex items-center justify-center font-mono text-ekko-300 font-bold text-xl drop-shadow-lg z-10">~ Flow ~</div>
                                <BorderBeam size={250} duration={12} delay={9} />
                            </div>}
                            icon={<Zap className="h-4 w-4 text-ekko-400" />}
                            className="md:col-span-2 border-white/5 bg-neutral-900/80 backdrop-blur-sm hover:border-ekko-500/30 transition-all group"
                            href="/live-radio"
                        />
                    </BentoGrid>
                </section>
                ...
                <section className="py-24 px-6 md:px-12 lg:px-24 border-b border-white/10 bg-black/95 relative overflow-hidden">
                    <div className="absolute inset-0 bg-ekko-900/10 blur-[120px] pointer-events-none" />
                    ...
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <BlurFade delay={0.25} inView>
                                ...
                                <div className="space-y-4 mb-8">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center gap-4 group cursor-pointer p-3 rounded-none hover:bg-white/5 transition-all border border-transparent hover:border-white/5">
                                            <div className="w-10 h-10 rounded-none bg-neutral-900 flex items-center justify-center group-hover:scale-110 transition-transform">
                                                <item.icon className="w-5 h-5 text-neutral-400 group-hover:text-ekko-400 transition-colors" />
                                            </div>
                                ...
                                <Link href="/login">
                                    <Button className="w-fit rounded-none px-8 h-12 bg-white text-black hover:bg-neutral-200 font-bold">
                                        Start Your Journey
                                    </Button>
                                </Link>
                            </BlurFade>
                        ...
                        <div className="relative h-[400px] lg:h-[500px] w-full rounded-none overflow-hidden border border-white/10 group order-1 lg:order-2 shadow-2xl">
                            <Image
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-br from-ekko-900/40 via-ekko-700/35 to-ekko-500/30 mix-blend-overlay" />
                            <div className="absolute inset-0 bg-[url('/grid-pattern.svg')] opacity-20" />

                            {/* Animated Orbs representing users */}
                            <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-ekko-500/20 rounded-full blur-2xl animate-pulse" />
                            <div className="absolute bottom-1/3 right-1/4 w-40 h-40 bg-ekko-700/20 rounded-full blur-3xl animate-pulse delay-700" />
                            ...
                            <div className="absolute bottom-6 left-6 right-6">
                                <div className="bg-black/60 border border-white/10 backdrop-blur-xl p-5 rounded-none">
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className="w-2 h-2 bg-ekko-500 rounded-none animate-pulse shadow-[0_0_10px_rgba(99,102,241,0.5)]" />
                    ...
                    <Marquee pauseOnHover className="[--duration:60s] [--gap:6rem]" style={{ gap: "6rem" }}>
                        {aiKeywords.map((keyword, i) => (
                            <div key={i} className="flex items-center gap-8 md:gap-16 group cursor-default">
                                ...
                                <Sparkles className="w-8 h-8 md:w-12 md:h-12 text-ekko-500/20 group-hover:text-ekko-400 opacity-50 group-hover:opacity-100 transition-all duration-500 animate-pulse" />
                            </div>
                        ))}
                    </Marquee>
                </section>
